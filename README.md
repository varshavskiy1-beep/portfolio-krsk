...
Зеркало GitHub Pages: https://varshavskiy1-beep.github.io/portfolio-krsk/ — собирается с `VITE_BASE=/portfolio-krsk/` и публикуется в ветку `gh-pages` (workflow `.github/workflows/pages.yml` на каждый push в `master`). Канонический URL остаётся Vercel.
